  ...
  <div class="bg-white font-inter">
    ...
    <main v-else class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex items-center space-x-2 text-gray-500 mb-8">
        ...
        <span>/</span>
        <span class="text-gray-700 font-medium">{{ course?.title || 'Yin Yang Harmony Yoga' }}</span>
      </nav>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div class="space-y-6 text-lg">
            ...
            <div>
              ...
              <p class="text-gray-600 leading-relaxed">This instructor is currently teaching <span class="font-bold text-gray-800">{{ course?.title || 'Yin Yang Harmony Yoga' }}</span>.</p>
...
const currentCourseSlug = 'yin-yang-harmony-yoga';
const currentCourseName = 'Yin-Yang Harmony Yoga';
...
const mainTeacher = computed(() => {
  ...
  // Based on the data, Kenji Tanaka teaches Yin-Yang Harmony Yoga.
  return allTeachers.value.find(t => t.name === 'Kenji Tanaka') || null;
});
...
watchEffect(() => {
  const title = mainTeacher.value 
    ...
    : 'Yin-Yang Harmony Yoga Course';
  
  const description = mainTeacher.value 
    ? `Learn about the Yin-Yang Harmony Yoga course taught by ${mainTeacher.value.name}.` 
    : 'Details about the Yin-Yang Harmony Yoga course.';
